...
function light(){
    ...
    document.querySelectorAll(".whey a")[1].style.color = "#1b1e22";
    document.querySelectorAll(".creatine a")[1].style.color = "#1b1e22";
}
...
function dark(){
    ...
    document.querySelectorAll(".whey a")[1].style.color = "#c6cbd2";
    document.querySelectorAll(".creatine a")[1].style.color = "#c6cbd2";
}
